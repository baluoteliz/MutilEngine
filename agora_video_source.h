    ...
    namespace rtc{
        ...
        public:
            ...
            */
			...
			virtual node_error setupLocalVideo(HWND hWnd, agora::rtc::RENDER_MODE_TYPE renderMode) = 0;
            ...
            */
			...
			/**
			*/
			virtual node_error setVideoSourceVideoEncoderConfiguration(VideoEncoderConfiguration config) = 0;
            ...
            */
			virtual node_error setParameters(const char* parameters) = 0;
